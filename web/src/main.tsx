...
function App() {
  ...
  return <main className="dashboard">
    ...
    {error && <div className="alert" role="alert"><span>{error}</span><div className="alert-actions"><button onClick={() => void load()}>Retry connection</button><button onClick={() => setError("")}>Dismiss</button></div></div>}
